...
int main() {
    ...
    STCPManager manager(0, 0.05, 0.5, false);

    manager.generateGraph();

    Trip res = manager.pathBeetweenStops("CUS4", "HSJ6");

    //Trip  res = manager.pathBeetweenStops(41.20572900, -8.64556100, "HSJ11");

    //Trip  res = manager.pathBeetweenStops(41.20572900, -8.64556100, 41.17823993192844, -8.598242093181291);
